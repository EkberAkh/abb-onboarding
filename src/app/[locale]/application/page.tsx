    ...
    <>
      ...
      <CloseButton position='absolute' right={0} top={0} size="lg" m="30px" />
        ...
        <Flex flexDirection="column" gap="16px">
          ...
          <Text>
            Bununla razılıq verirəm ki, ASAN Finans sistemi vasitəsilə şəxsiyyət
            vəsiqəm və VÖEN üzrə müəyyən olunan məlumatlar qeydiyyatdan keçmək
            üçün ABB ASC yə təqdim olunsun.
          </Text>
          <Text>
          ...
          <Text>
            ...
            xitam verildikdən sonra məlumatlar qanunvericilikdə nəzərdə tutulmuş
            qaydada arxivləşdirilsin (ləğv edilsin).
          </Text>
